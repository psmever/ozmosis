...
./bin/OZMTool --ozmupdate --aggressivity 1 --compressdxe --out ./output/create_ozmosis_Z87XUD3H_SM_DSDT_$current_time.rom --input ./rom/Z87XUD3H.10b-XMAX.rom --recent ./output/Z87XUD3H_SM_DSDT_20190209164011.10b.rom